...
| [`ableton`](https://github.com/ringo380/ableton-mcp-max) | creative | Drive Ableton Live 11 from Claude Code — tracks, clips, MIDI notes, devices, mixer, automation, arrangement, scenes, transport, and preset generation (Wavetable, Simpler, rack macros & zones) over a bundled MCP server. Includes a guided /ableton:setup plus best-practice workflow commands for building and editing tracks. | [`v0.2.0`](https://github.com/ringo380/ableton-mcp-max/releases/tag/v0.2.0) | [ringo380/ableton-mcp-max](https://github.com/ringo380/ableton-mcp-max) |
<!-- END:PLUGINS-TABLE -->
