...
| [`notation`](https://github.com/Robworks-Code/notation) | productivity | Capture session learnings into the right Claude Code memory tier. /notation:notate routes each learning to global CLAUDE.md, ~/.claude/notes/, per-project MEMORY.md, or project docs, with a lean bias that keeps CLAUDE.md small. Ships a notation-audit skill that flags bloat, stale notes, and orphaned index entries. | [`v0.1.0`](https://github.com/Robworks-Code/notation/releases/tag/v0.1.0) | [Robworks-Code/notation](https://github.com/Robworks-Code/notation) |
<!-- END:PLUGINS-TABLE -->
